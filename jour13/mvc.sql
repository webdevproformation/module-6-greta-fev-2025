...
--
-- Hôte : localhost
-- Généré le : jeu. 13 fév. 2025 à 08:12
...
(2, 'blog sur le mr Bricolage et jardinage', 5, 'jour'),
(3, 'nouveau projet en informatique modification', 2, 'jour'),
(7, 'réaliser une site internet en PHP à la main', 3, 'jour'),
(8, 'créer un site internet de recette de cuisine', 4, 'semaine');
...
(5, 'nouveau@yahoo.fr', '$2y$10$uptPioRVx.l42iOamjDWWuJExN4IC0WaaOJlmfW1dPdIIB29oYMoq', 'redacteur', '2025-02-12 11:32:04'),
(6, 'alain@yahoo.fr', '$2y$10$bZbf0S2TY9SHy4nnEhbJ/OaOb9IyJlXEmiDzwOj3wQsZKLFfp.khW', 'redacteur', '2025-02-13 08:03:53');
