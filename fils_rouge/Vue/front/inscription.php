<main class="container">
    ...
    <p>Vous voulez ajouter une nouvelle recette dans le site, veuillez créer au préalable un profil utilisateur via la formulaire suivant : </p>
    ...
    <?php foreach ($success as $succes) : ?>
        <div class="alert bg-success mt-3"><?php echo $succes ?></div>
    <?php endforeach ?> 
</main>